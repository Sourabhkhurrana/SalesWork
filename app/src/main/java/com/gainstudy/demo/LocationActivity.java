...
//Ui widgets
    ...
    private TextView tv_pincode, tv_city, state, knownname;
...
//                    "isGooglePlayServicesAvailable SUCCESS",Toast.LENGTH_LONG).show();
    ...
    protected void onResume() {
        ...
        if (mGoogleApiClient.isConnected() && mRequestingLocationUpdates) {
            Toast.makeText(LocationActivity.this, "location was already on so detecting location now", Toast.LENGTH_SHORT).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        knownname = (TextView) findViewById(R.id.KnownName);

        // Set labels.
        mLatitudeLabel = "Label Latitude";
        mLongitudeLabel = "Label Longitude";
        mLastUpdateTimeLabel = "Last Update Time";
...
//        });
    ...
    protected void startLocationUpdates() {
        if (ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ...
            Toast.makeText(this,"function",Toast.LENGTH_LONG).show();
            return;
        }
    ...
    public void onLocationChanged(Location location) {
        ...
        mLastUpdateTime = DateFormat.getTimeInstance().format(new Date());
        updateLocationUI();
        Toast.makeText(this, "updated_message",
    ...
    private void updateCityAndPincode(double latitude, double longitude) {
        ...
        try {
            ...
            if (addresses.size() > 0) {
                ...
                tv_pincode.setText("Full Address=" + sb);

                //state.setText("\nState= "+addresses.get(0).getAdminArea());
                //knownname.setText("Known Name = "+addresses.get(0).getFeatureName());
